...
<html>
    ...
    <body>
        ...
        <div id="show-carrito" class="content scaffold-show" role="main">
            ...
            <f:display bean="carrito" />
            <g:form resource="${this.carrito}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.carrito}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
