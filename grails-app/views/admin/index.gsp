<!DOCTYPE html>
<html lang="en-us"><style type="text/css" id="night-mode-pro-style"></style><link type="text/css" rel="stylesheet" id="night-mode-pro-link"><head>
    ...
    <!-- Google Font -->
    <link href="Home%20Overview%20|%20Dashboard%20UI%20Kit_files/css.css" rel="stylesheet">
    ...
    <!-- Stylesheet -->
    <link rel="stylesheet" href="Home%20Overview%20|%20Dashboard%20UI%20Kit_files/main.css">
    ...
    <div class="c-sidebar">
        ...
        <ul class="c-sidebar__list">
            ...
            <li class="c-sidebar__item">
                <a class="c-sidebar__link is-active" href="https://zawiastudio.com/dashboard/demo/home-overview.html">
                    <i class="fa fa-home u-mr-xsmall"></i>Overview
                </a>
            </li>

            <li class="c-sidebar__item">
                <a class="c-sidebar__link" href="https://zawiastudio.com/dashboard/demo/performance.html">
            ...
            <li class="c-sidebar__item">
                <a class="c-sidebar__link" href="https://zawiastudio.com/dashboard/demo/analytics.html">
                    <i class="fa fa-line-chart u-mr-xsmall"></i>Analytics
                </a>
            </li>

            <li class="c-sidebar__item">
                <a class="c-sidebar__link" target="_blank" href="https://zawiastudio.com/dashboard/demo/index.html">
                    <i class="fa fa-rocket u-mr-xsmall"></i>Landing
                </a>
            </li>

            <li class="c-sidebar__item">
                <a class="c-sidebar__link" target="_blank" href="https://zawiastudio.com/dashboard/demo/projects.html">
        ...
        <ul class="c-sidebar__list">
            <li class="c-sidebar__item">
                <a class="c-sidebar__link" target="_blank" href="https://zawiastudio.com/dashboard/demo/boards.html">
                    <i class="fa fa-hand-paper-o u-mr-xsmall"></i>Boards (CRM)
                </a>
            </li>
            <li class="c-sidebar__item">
                <a class="c-sidebar__link" href="https://zawiastudio.com/dashboard/demo/calendar.html">
                    <i class="fa fa-calendar u-mr-xsmall"></i>Calendar
                </a>
            </li>
            <li class="c-sidebar__item">
                <a class="c-sidebar__link" target="_blank" href="https://zawiastudio.com/dashboard/demo/news-feed.html">
                    <i class="fa fa-newspaper-o u-mr-xsmall"></i>News Feed
                </a>
            </li>
            <li class="c-sidebar__item">
                <a class="c-sidebar__link" href="https://zawiastudio.com/dashboard/demo/messanger.html">
                    <i class="fa fa-comment-o u-mr-xsmall"></i>Messanger
                </a>
            </li>
            <li class="c-sidebar__item">
                <a class="c-sidebar__link" target="_blank" href="https://zawiastudio.com/dashboard/demo/projects-board.html">
        ...
        <ul class="c-sidebar__list">
            <li class="c-sidebar__item">
                <a class="c-sidebar__link" href="https://zawiastudio.com/dashboard/demo/user-profile.html">
                    <i class="fa fa-street-view u-mr-xsmall"></i>User Profile <span class="c-badge c-badge--success c-badge--xsmall u-ml-xsmall">New</span>
                </a>
            </li>

            <li class="c-sidebar__item">
                <a class="c-sidebar__link" href="https://zawiastudio.com/dashboard/demo/invoices.html">
                    <i class="fa fa-files-o u-mr-xsmall"></i>Invoices
                </a>
            </li>

            <li class="c-sidebar__item">
                <a class="c-sidebar__link" href="https://zawiastudio.com/dashboard/demo/invoice.html">
            ...
            <li class="c-sidebar__item">
                <a class="c-sidebar__link" target="_blank" href="https://zawiastudio.com/dashboard/demo/browse.html">
                    <i class="fa fa-list-alt u-mr-xsmall"></i>Browse
                </a>
            </li>

            <li class="c-sidebar__item">
                <a class="c-sidebar__link" href="https://zawiastudio.com/dashboard/demo/active-projects.html">
                    <i class="fa fa-folder u-mr-xsmall"></i>Active Projects
                </a>
            </li>

            <li class="c-sidebar__item">
                <a class="c-sidebar__link" target="_blank" href="https://zawiastudio.com/dashboard/demo/events.html">
                    <i class="fa fa-clock-o u-mr-xsmall"></i>Events
                </a>
            </li>

            <li class="c-sidebar__item">
                <a class="c-sidebar__link" target="_blank" href="https://zawiastudio.com/dashboard/demo/ios-apps-list.html">
                    <i class="fa fa-apple u-mr-xsmall"></i>iOS Apps List
                </a>
            </li>

            <li class="c-sidebar__item">
                <a class="c-sidebar__link" href="https://zawiastudio.com/dashboard/demo/plans.html">
                    <i class="fa fa-bullhorn u-mr-xsmall"></i>Pricing
                </a>
            </li>

            <li class="c-sidebar__item">
                <a class="c-sidebar__link" target="_blank" href="https://zawiastudio.com/dashboard/demo/404.html">
                    <i class="fa fa-chain-broken u-mr-xsmall"></i>404 Page<span class="c-badge c-badge--success c-badge--xsmall u-ml-xsmall">New</span>
                </a>
            </li>
        ...
        <ul class="c-sidebar__list">
            <li class="c-sidebar__item">
                <a class="c-sidebar__link" target="_blank" href="https://zawiastudio.com/dashboard/demo/account-details.html">
                    <i class="fa fa-user-circle u-mr-xsmall"></i>Account Details
                </a>
            </li>

            <li class="c-sidebar__item">
                <a class="c-sidebar__link" href="https://zawiastudio.com/dashboard/demo/account-settings.html">
                    <i class="fa fa-cog u-mr-xsmall"></i>Account Settings
                </a>
            </li>

            <li class="c-sidebar__item">
                <a class="c-sidebar__link" target="_blank" href="https://zawiastudio.com/dashboard/demo/register.html">
                    <i class="fa fa-user-plus u-mr-xsmall"></i>Register <span class="c-badge c-badge--success c-badge--xsmall u-ml-xsmall">New</span>
                </a>
            </li>

            <li class="c-sidebar__item">
                <a class="c-sidebar__link" href="https://zawiastudio.com/dashboard/demo/login.html">
        ...
        <ul class="c-sidebar__list">
            <li class="c-sidebar__item">
                <a class="c-sidebar__link" href="https://zawiastudio.com/dashboard/demo/ui-overview.html">
...
<main class="o-page__content">
    <header class="c-navbar u-mb-medium">
        ...
        <div class="c-dropdown u-hidden-down@mobile">
            ...
            <div class="c-dropdown__menu c-dropdown__menu--large dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuUser">
                <a href="#" class="c-dropdown__item dropdown-item o-media">
                    <span class="o-media__img u-mr-xsmall">
                        <span class="c-avatar c-avatar--xsmall">
                            <img class="c-avatar__img" src="Home%20Overview%20|%20Dashboard%20UI%20Kit_files/avatar2-72.jpg" alt="User's Profile Picture">
                        </span>
                    </span>
                ...
                <a href="#" class="c-dropdown__item dropdown-item o-media">
                    <span class="o-media__img u-mr-xsmall">
                        <span class="c-avatar c-avatar--xsmall">
                            <img class="c-avatar__img" src="Home%20Overview%20|%20Dashboard%20UI%20Kit_files/avatar3-72.jpg" alt="User's Profile Picture">
                        </span>
                    </span>
                    <div class="o-media__body">
                ...
                <a href="#" class="c-dropdown__item dropdown-item o-media">
                    <span class="o-media__img u-mr-xsmall">
                        <span class="c-avatar c-avatar--xsmall">
                            <img class="c-avatar__img" src="Home%20Overview%20|%20Dashboard%20UI%20Kit_files/avatar4-72.jpg" alt="User's Profile Picture">
                        </span>
                    </span>
                    <div class="o-media__body">
        ...
        <div class="c-dropdown dropdown">
            <a class="c-avatar c-avatar--xsmall has-dropdown dropdown-toggle" href="#" id="dropdwonMenuAvatar" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <img class="c-avatar__img" src="Home%20Overview%20|%20Dashboard%20UI%20Kit_files/avatar-72.jpg" alt="User's Profile Picture">
            </a>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-4">
                <div class="c-graph-card">
                    ...
                    <div class="c-graph-card__chart"><div style="position: absolute; left: 0px; top: 0px; right: 0px; bottom: 0px; overflow: hidden; pointer-events: none; visibility: hidden; z-index: -1;" class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:1000000px;height:1000000px;left:0;top:0"></div></div><div class="chartjs-size-monitor-shrink" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:200%;height:200%;left:0; top:0"></div></div></div>
                        <canvas id="js-chart-payout" width="302" height="74" style="display: block; width: 302px; height: 74px;" class="chartjs-render-monitor"></canvas>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-4">
                <div class="c-graph-card">
                    ...
                    <div class="c-graph-card__chart"><div style="position: absolute; left: 0px; top: 0px; right: 0px; bottom: 0px; overflow: hidden; pointer-events: none; visibility: hidden; z-index: -1;" class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:1000000px;height:1000000px;left:0;top:0"></div></div><div class="chartjs-size-monitor-shrink" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:200%;height:200%;left:0; top:0"></div></div></div>
                        <canvas id="js-chart-earnings" width="302" height="74" style="display: block; width: 302px; height: 74px;" class="chartjs-render-monitor"></canvas>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-sm-6 col-lg-6 col-xl-3">
                ...
                <div class="c-project-card u-mb-medium">
                    <img class="c-project-card__img" src="Home%20Overview%20|%20Dashboard%20UI%20Kit_files/project-card1.jpg" alt="About the image">
            ...
            <div class="col-sm-6 col-lg-6 col-xl-3">
                ...
                <div class="c-project-card u-mb-medium">
                    <img class="c-project-card__img" src="Home%20Overview%20|%20Dashboard%20UI%20Kit_files/project-card2.jpg" alt="About the image">
            ...
            <div class="col-sm-6 col-lg-6 col-xl-3">
                ...
                <div class="c-project-card u-mb-medium">
                    <img class="c-project-card__img" src="Home%20Overview%20|%20Dashboard%20UI%20Kit_files/project-card3.jpg" alt="About the image">
            ...
            <div class="col-sm-6 col-lg-6 col-xl-3">
                ...
                <div class="c-project-card u-mb-medium">
                    <img class="c-project-card__img" src="Home%20Overview%20|%20Dashboard%20UI%20Kit_files/project-card4.jpg" alt="About the image">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="c-card u-overflow-scroll u-mb-medium">
                ...
                <div class="c-card u-mb-medium">
                    ...
                    <div class="c-todo">
                        <label class="c-todo__content">
                            <input class="c-todo__input" name="exampe-list" type="checkbox">
                            Create new prototype for the landing page
                        </label>
                        <span class="c-badge c-badge--small c-badge--danger">Due Today</span>
                    </div><!-- // .c-todo -->

                    <div class="c-todo">
                        <label class="c-todo__content" for="task2">
                            <input class="c-todo__input" name="exampe-list" id="task2" type="checkbox">
                            Add new Google Analytics code to all main files
                        </label>
                        <span class="c-badge c-badge--small c-badge--secondary">Due in 3 Days</span>
                    </div><!-- // .c-todo -->

                    <div class="c-todo">
                        <label class="c-todo__content" for="task3">
                            <input class="c-todo__input" name="exampe-list" id="task3" type="checkbox">
                            Finish Dashboard UI Kit update
                        </label>
                        <span class="c-badge c-badge--small c-badge--secondary">Due in 6 Days</span>
                    </div><!-- // .c-todo -->

                    <div class="c-todo is-completed">
                        <label class="c-todo__content" for="task4">
                            <input class="c-todo__input" name="exampe-list" id="task4" checked="checked" type="checkbox">
                            Update parallax scroll on team page
                        </label>
                        <span class="c-badge c-badge--small c-badge--secondary">Finished</span>
                    </div><!-- // .c-todo -->

                    <div class="c-todo is-completed">
                        <label class="c-todo__content" for="task5">
                            <input class="c-todo__input" name="exampe-list" id="task5" checked="checked" type="checkbox">
                            Update parallax scroll on team page
                        </label>
                        <span class="c-badge c-badge--small c-badge--secondary">Finished</span>
                    </div><!-- // .c-todo -->
...
<script src="Home%20Overview%20|%20Dashboard%20UI%20Kit_files/main.js"></script>
...
<script src="Home%20Overview%20|%20Dashboard%20UI%20Kit_files/analytics.js" async="" defer="defer"></script>
