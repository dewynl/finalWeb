...
<div class="wrapper">
    ...
    <!-- PAGE SECTION START -->
    <div class="page-section section pt-120 pb-120 show open">
        <div class="container">
                        ...
                        <div class="isotope-item col-lg-3 col-md-4 col-sm-6 col-xs-12 mb-50"
                            ...
                            <div class="product-item product-item-2 text-center">
                                ...
                                <div class="product-img">
                                    <!-- Image -->
                                    <a class="image" href="/articulo/show/${a.id}"><img
                                            src="data:image/png;base64,${a.foto}" alt=""></a>
                                </div>
                                <!-- Portfolio Info -->
                                <div class="product-info">
                                    <!-- Title -->
                                    <h5 class="title"><a href="/articulo/show/${a.id}">${a.nombre}</a></h5>
                                    <!-- Price -->
            ...
            <div class="modal-content row">
                <div class="modal-body">
                    ...
                    <div class="col-md-5 col-sm-6 col-xs-12 mb-40">
                        ...
                        <div class="pro-thumb-img-slider slick-initialized slick-slider"><button type="button"
                                                                                                 class="arrow-prev slick-arrow"
                                                                                                 style=""><i
                                    class="fa fa-angle-left"></i></button>


                            <div aria-live="polite" class="slick-list draggable"><div class="slick-track" role="listbox"
                                                                                      style="opacity: 1; width: 1386px; transform: translate3d(-378px, 0px, 0px);"><div
                                        class="slick-slide slick-cloned" tabindex="-1" role="option"
                                        aria-describedby="slick-slide02" style="width: 126px;" data-slick-index="-3"
                                        aria-hidden="true"><a href="#pro-large-img-3" data-toggle="tab"
                                                              tabindex="-1"><img src="img/product/20.jpg" alt=""></a>
                                </div>

                                <div class="slick-slide slick-cloned" tabindex="-1" role="option"
                                     aria-describedby="slick-slide03" style="width: 126px;" data-slick-index="-2"
                                     aria-hidden="true"><a href="#pro-large-img-4" data-toggle="tab" tabindex="-1"><img
                                        src="img/product/22.jpg" alt=""></a></div>

                                <div class="slick-slide slick-cloned" tabindex="-1" role="option"
                                     aria-describedby="slick-slide04" style="width: 126px;" data-slick-index="-1"
                                     aria-hidden="true"><a href="#pro-large-img-5" data-toggle="tab" tabindex="-1"><img
                                        src="img/product/23.jpg" alt=""></a></div>

                                <div class="slick-slide slick-current slick-active" tabindex="-1" role="option"
                                     aria-describedby="slick-slide00" style="width: 126px;" data-slick-index="0"
                                     aria-hidden="false"><a href="#pro-large-img-1" data-toggle="tab" tabindex="0"><img
                                        src="img/product/19.jpg" alt=""></a></div>

                                <div class="slick-slide slick-active" tabindex="-1" role="option"
                                     aria-describedby="slick-slide01" style="width: 126px;" data-slick-index="1"
                                     aria-hidden="false"><a href="#pro-large-img-2" data-toggle="tab" tabindex="0"><img
                                        src="img/product/18.jpg" alt=""></a></div>

                                <div class="slick-slide slick-active" tabindex="-1" role="option"
                                     aria-describedby="slick-slide02" style="width: 126px;" data-slick-index="2"
                                     aria-hidden="false"><a href="#pro-large-img-3" data-toggle="tab" tabindex="0"><img
                                        src="img/product/20.jpg" alt=""></a></div>

                                <div class="slick-slide" tabindex="-1" role="option" aria-describedby="slick-slide03"
                                     style="width: 126px;" data-slick-index="3" aria-hidden="true"><a
                                        href="#pro-large-img-4" data-toggle="tab" tabindex="-1"><img
                                            src="img/product/22.jpg" alt=""></a></div>

                                <div class="slick-slide" tabindex="-1" role="option" aria-describedby="slick-slide04"
                                     style="width: 126px;" data-slick-index="4" aria-hidden="true"><a
                                        href="#pro-large-img-5" data-toggle="tab" tabindex="-1"><img
                                            src="img/product/23.jpg" alt=""></a></div>

                                <div class="slick-slide slick-cloned" tabindex="-1" role="option"
                                     aria-describedby="slick-slide00" style="width: 126px;" data-slick-index="5"
                                     aria-hidden="true"><a href="#pro-large-img-1" data-toggle="tab" tabindex="-1"><img
                                        src="img/product/19.jpg" alt=""></a></div>

                                <div class="slick-slide slick-cloned" tabindex="-1" role="option"
                                     aria-describedby="slick-slide01" style="width: 126px;" data-slick-index="6"
                                     aria-hidden="true"><a href="#pro-large-img-2" data-toggle="tab" tabindex="-1"><img
                                        src="img/product/18.jpg" alt=""></a></div>

                                <div class="slick-slide slick-cloned" tabindex="-1" role="option"
                                     aria-describedby="slick-slide02" style="width: 126px;" data-slick-index="7"
                                     aria-hidden="true"><a href="#pro-large-img-3" data-toggle="tab" tabindex="-1"><img
                                        src="img/product/20.jpg" alt=""></a></div></div></div><button type="button"
