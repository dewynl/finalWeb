            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="float-right">
                        ...
                        <div class="mean-push"></div><nav class="main-menu menu-right float-right" style="display: none;">
                        <ul>
                    ...
                    <div class="mobile-menu mean-container"><div class="mean-bar"><a href="#nav" class="meanmenu-reveal" style="background:;color:;right:0;left:auto;"><i class="pe-7s-menu"></i></a><nav class="mean-nav">
                        <ul style="display: none;">
                            <li><a href="index.html">Home</a>
                                ...
                                <a class="mean-expand" href="#" style="font-size: 30px">+</a></li>
                            <li><a href="shop.html">shop</a>
                                <ul class="sub-menu" style="display: none;">
                                    <li><a href="shop.html">shop</a></li>
                                    <li><a href="product-details.html">product details</a></li>
                            ...
                            <li><a href="blog.html">Blog</a>
                                ...
                                <a class="mean-expand" href="#" style="font-size: 30px">+</a></li>
                            <li class="active mean-last"><a href="contact.html">Contact</a></li>
                        </ul>
                    </nav></div></div>
                </div>
            </div>
